      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          ...
          <ul class="navbar-nav ms-3">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center" href="http://localhost/cartsy/profile/test-1.php">Sell</a>
            </li>
      ...
      <div class="container">
        ...
        <div class="row row-cols-2 row-cols-sm-3 row-cols-lg-4 row-cols-xl-5 g-4">
          <?php
            ...
            $sql = "SELECT product_id, product_name, price, image_path, condition_name FROM products";  // Use the actual primary key
