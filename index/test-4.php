...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $condition = $_POST['condition_name'];

    $sql = "INSERT INTO products (name, price, image_path, condition_name) 
            VALUES ('$name', '$price', '$image_url', '$condition')";
    ...
    <section class="container-fluid product-grid-section">
      <div class="container">
        ...
        <div class="row row-cols-2 row-cols-sm-3 row-cols-lg-4 row-cols-xl-5 g-4">
          <?php
          // Fetching data from the "products" table in your database
          $sql = "SELECT name, price, image_path, condition_name FROM products";
