    ...
    <div class="row">
        ...
        <aside class="col-lg-3 col-md-4 col-sm-12 mb-4 position-sticky" style="top: 110px; height: fit-content;">
            <div class="p-3 border rounded bg-white">
                ...
                <form action="http://localhost/cartsy/search-product/test-4.php" method="GET">
                    <!-- Category Filter -->
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<div class="col-lg-3 col-md-4 col-sm-6">
                            ...
                            <a href="/cartsy/view-product/test-1-0.php?id=' . $row["product_id"] . '" class="text-decoration-none">
                                <div class="card shadow-sm border-0 position-relative product-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">' . htmlspecialchars($row["condition_name"]) . '</p>
