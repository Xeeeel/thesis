...
$current_user_id = $_SESSION['user_id']; // make sure user is logged in
$seller_id = intval($_GET['seller_id']);
$product_id = intval($_GET['product_id']);

// Mark who is sender/receiver
$receiver_id = $seller_id;

// Fetch product and seller info for header
$product_info = $conn->query("SELECT product_name FROM products WHERE product_id = $product_id")->fetch_assoc();
$seller_info = $conn->query("SELECT name FROM users WHERE id = $seller_id")->fetch_assoc();
?>
