<?php
session_start();
require_once __DIR__ . '/../config/db_config.php'; // ✅ Connect to PDO config
$pdo = db();
...
// ✅ Query to get all saved products
$query = "
...
function startChat(sellerId, productId) {
    var buyerId = <?php echo isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 'null'; ?>;
    if (buyerId !== null) {
