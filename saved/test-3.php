...
<div class="container mt-4">
  ...
  <?php while ($row = $result->fetch_assoc()): ?>
    ...
    <div class="seller-name"><?php echo htmlspecialchars($row['seller_name']); ?></div>
    <div class="d-md-flex product-card align-items-center">
      <div class="col-md-6 d-flex align-items-center">
        <!-- Product Image -->
        <img src="<?php echo htmlspecialchars($row['image_path']) ?: 'path/to/default_image.jpg'; ?>" alt="Product" class="product-image">
        <div class="product-info">
          <div class="product-title"><?php echo htmlspecialchars($row['product_name']); ?></div>
          <div class="product-location"><?php echo htmlspecialchars($row['location']); ?></div>
        </div>
      </div>
