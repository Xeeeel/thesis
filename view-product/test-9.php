      ...
      <div class="container-fluid">
        ...
        <div>
            <?php
                ...
                <!-- HTML Section -->
                <i class="bi bi-chat fs-4 me-3" onclick="startChat(<?php echo $seller_id; ?>, <?php echo $product_id; ?>)"></i>
...
?>
    ...
    <script>
      ...
      function startChat(sellerId, productId, buyerId) {
        // Redirect to the chat page with seller, buyer, and product info
        window.location.href = `/cartsy/chat/conversation.php?seller_id=${sellerId}&product_id=${productId}&buyer_id=${buyerId}`;
      }
