...
$sellerId = 1; // This should be dynamically set based on the seller you're viewing
      ...
      <div class="mb-4">
        <p><strong>Documents:</strong>
          <?php if ($seller['id_front']): ?>
            <a href="<?php echo htmlspecialchars($seller['id_front']); ?>" class="btn btn-sm btn-outline-primary">View Front ID</a>
          <?php endif; ?>
          <?php if ($seller['id_back']): ?>
            <a href="<?php echo htmlspecialchars($seller['id_back']); ?>" class="btn btn-sm btn-outline-secondary">View Back ID</a>
          <?php endif; ?>
        </p>
      </div>
