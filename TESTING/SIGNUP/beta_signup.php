...
function sendOtpMail(string $toEmail, string $otp, ?string &$err = null): bool {
  ...
  try {
    ...
    $mail->Password = 'dhao ftdk vxqt abdm';      // your Gmail App Password (no spaces)
  ...
  <body class="body">
    <nav class="navbar sticky-top navbar-expand-lg bg-body-tertiary p-3">
      <div class="container-fluid brand">
        <a class="navbar-brand suranna-regular" href="../index/test-7.php">Cartsy</a>
      </div>
    </nav>

    <div class="container-fluid login-page">
      <div class="background-image"></div>
      <div class="row justify-content-center align-items-center vh-100 px-3">
        <div class="col-xl-4 col-lg-5 col-md-6 col-sm-10 col-12">
          <div class="login-box">
            ...
            <?php elseif (!empty($registrationError)): ?>
              <div class="alert alert-danger text-center"><?php echo $registrationError; ?></div>
            <?php endif; ?>

            <form method="POST" action="">
              <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" id="email" name="email" class="form-control" required value="<?= htmlspecialchars($inputEmail ?? '') ?>">
              ...
              <div class="mb-3">
                ...
                <small class="text-danger"><?= htmlspecialchars($confirmPasswordError ?? '') ?></small>
              </div>
            ...
            <p class="text-center mt-4">
              ...
              <a href="../login/login.php" class="text-danger">Log In Here</a>
            </p>
          </div>
        </div>
      </div>
