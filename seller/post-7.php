...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO products (product_name, price, category, condition_name, location, description, seller_id) 
            VALUES (?, ?, ?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sdssssi", $title, $price, $category, $condition_status, $location, $description, $user_id);
