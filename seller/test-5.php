...
// Modify SQL query to filter by the logged-in user (seller)
$sql = "SELECT product_id, product_name, price, thumbnail, condition_name 
        FROM products 
        WHERE seller_id = ?";
...
if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "
        <div class='col'>
            <a href='/cartsy/view-product/test-8.php?id={$product_id}' class='text-decoration-none'>
                <div class='card product-card'>
                    <div class='position-relative'>
                        <button class='save-heart'><i class='bi bi-heart'></i></button>
