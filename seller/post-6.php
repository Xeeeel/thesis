...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO products (title, price, category, condition_status, location, deal_option, description) 
            VALUES (?, ?, ?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sdssss", $title, $price, $category, $condition_status, $location, $deal_option, $description);
